...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HelloTypeSpec) DeepCopyInto(out *HelloTypeSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelloTypeSpec.
func (in *HelloTypeSpec) DeepCopy() *HelloTypeSpec {
	if in == nil {
		return nil
	}
	out := new(HelloTypeSpec)
	in.DeepCopyInto(out)
	return out
}
